---
title: "EC 421"
subtitle: "Final Review Questions from \"New\" Lectures"
#author: "Edward Rubin"
date: "Spring 2020"
output:
...
**Note.sub[2]:** **We will not provide an answer key to these review questions.**
...
11\. Explain why OLS is biased for dyanmic models with lagged dependent variables and autocorrelated disturbances. It may be helpful to $(a)$ write out a model with a lagged dependent variable and $(b)$ write out an AR(1) disturbance.

12\. What are the null and alternative hypotheses for a Breusch-Godfrey test?

13\. If a Breusch-Godfrey test rejects H.sub[o], what do we conclude? What if it fails to reject H.sub[o]?
...
21\. What is the fundamental problem of causal inferenece? How do we "deal" with it?
...
Review the "ideal dataset/experiment" in the causality lecture and instrumental variables lecture. Explain why the "ideal" is not possible? Using the provided example data, calculate (**1**) individual treatment effects, (**2**) average treatment effects, (**3**) difference in means between the treatment and control groups, and (**4**) selection bias.
