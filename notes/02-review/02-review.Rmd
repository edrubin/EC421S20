...
Normally: .mono[R] is [available at all academic workstations at UO](https://library.uoregon.edu/library-technology-services/public-info/a-software).
...
Let's consider the dataset we previously generated. $\color{#ffffff}{\bigg|}$
